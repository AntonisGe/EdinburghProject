# this enviroment does not work
# it is used only to return SSA state space. LITERALY EVERYTHING ELSE DOES NOT WORK
# functions that work : GOAT_features on line 192, the features mentioned in the report
# AGAIN ANY OTHER FUNCTION DOES NOT WORK, the other enviroment is the one that works.
...
if __name__ == '__main__':
    ...
    env = Enviroment(stocks = ['AAPL','BA'], start = start, end = end, transaction_cost=0.5,variance = 0,p_finder=shares,cluster = c,lookback = 20)

    #test = env.GOAT_features('AAPL')
