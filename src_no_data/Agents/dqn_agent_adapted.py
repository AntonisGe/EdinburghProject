...
# the work here is an adaption of 
...
# CLASS DQN is for CA VERSION 3
# CLASS DQN_Agent_Adapted is for SSA
...
class DQN:
    ...
    def save_buffer(self):
        save(self.directory + 'x_memory.npy',self.x_memory)
        save(self.directory + 'new_x_memory.npy',self.new_x_memory)
    ...
    def load_buffer(self):
        self.x_memory = load(self.directory + 'x_memory.npy')
        self.new_x_memory = load(self.directory + 'new_x_memory.npy')
