...
class network(nn.Module):
    def __init__(self,input_size,num_layers,hidden_size,num_output,added_size,x2_size,fc1_dims,fc2_dims,lr,wd):
        ...
        self.bn = nn.BatchNorm1d(num_output+x2_size+added_size) 
...
class simple_network(nn.Module):
    def __init__(self,input_size = 6,fc1_dims = 256, fc2_dims = 256, output = 20, lr = 1e-5, wd = 0):
    
        super(simple_network,self).__init__()
    
        self.fc1 = nn.Linear(input_size,fc1_dims)
        self.fc2 = nn.Linear(fc1_dims,fc2_dims)
        self.fc3 = nn.Linear(fc2_dims,output)
