...
class DQN_Agent:
    def __init__(self,gamma=0.95,max_mem_size = 100000,C=30,batch_size=30,epsilon=0.1, eps_min = 0.003, eps_dec = 5e-5
    ,num_layers=2,hidden_size=120,added_size=0,fc1_dims=100,fc2_dims=40,lr=0.001,wd=0,lookback=20):
    ...
    def store_transition(self,x1,x2,action,reward,new_x1,new_x2,done):
        ...
        if self.mem_cntr < self.mem_size:
            ...
            index = choice(range(self.mem_size))
...
if __name__ == '__main__':
    ...
    SSA = DQN_Agent(lr = 0.001,epsilon = 0.05,eps_min = 0.003,fc1_dims = 100,fc2_dims = 20)
