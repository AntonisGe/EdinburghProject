...
class DQN_Agent_Adapted:
    ...
    ,num_layers=2,hidden_size=120,added_size=0,fc1_dims=100,fc2_dims=40,lr=0.001,wd=0,lookback=20,x2_size=4,scheduler_max = 100,scheduler_initial=100):
...
if __name__ == '__main__':
    ...
    agent = DQN_Agent_Adapted('D:',batch_size=1)
    
    x1 = np.random.randn(20,7)
    x2 = [0,0,1,0]
    x1_next = np.random.randn(20,7)
    x2_next = [0,0,1,0]
    ...
    agent.store_transition(x1,x2,action,reward,x1_next,x2_next,done,1)
    agent.learn()
